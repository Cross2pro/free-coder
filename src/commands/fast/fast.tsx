...
import { formatModelPricing, getCurrentOpusCostTier } from '../../utils/modelCost.js';
...
export function FastModePicker(t0) {
  ...
  if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = formatModelPricing(getCurrentOpusCostTier(true));
    $[1] = t2;
  } else {
    t2 = $[1];
  }
...
async function handleFastModeShortcut(enable: boolean, getAppState: () => AppState, setAppState: (f: (prev: AppState) => AppState) => void): Promise<string> {
  ...
  if (enable) {
    ...
    const pricing = formatModelPricing(getCurrentOpusCostTier(true));
